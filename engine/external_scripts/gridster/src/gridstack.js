...
(function (factory) {
    ...
    var GridStack = function (el, opts) {
        ...
        this.opts = _.defaults(opts || {}, {
			...
			module    : parseInt(this.container.attr('data-id')),
            ...
            _.each(nodes, function (n) {
                if (n._id == null) {
					...
					if(typeof n.name !== 'undefined')
					 n.el.find('span.title_module').text(n.name);
			
				    if(typeof n.id !== 'undefined')
					  n.el.attr('id',n.id);
	                else
					 if(typeof n.id_m !== 'undefined')
					  n.el.attr('id',n.id_m);
					...
					//console.log(n);
					if(typeof serialized_json !== 'undefined'){
					 n.el.find('.grid-stack-item-content').html(serialized_json[n.module].module.content);
					 
					}
					//console.log(serialized_json);
                }
            });
    ...
    GridStack.prototype.add_widget = function (el, x, y, width, height, auto_position,module) {
	    //console.log(module);
        el = $(el);
        if (typeof module != 'undefined') el.attr('data-id', module);
